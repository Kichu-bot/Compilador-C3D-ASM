...
.DATA
    ...
    t4         DW ?
    MSG00      DB '==============================', 0Dh, 0Ah, '$'
    MSG01      DB '    CALCULADORA EXPANDIDA     ', 0Dh, 0Ah, '$'
    MSG02      DB '1. Sumar', 0Dh, 0Ah, '$'
    MSG03      DB '2. Restar', 0Dh, 0Ah, '$'
    MSG04      DB '3. Multiplicar', 0Dh, 0Ah, '$'
    MSG05      DB '4. Dividir', 0Dh, 0Ah, '$'
    MSG06      DB '0. Salir del programa', 0Dh, 0Ah, '$'
    MSG07      DB 'Elija una opcion: ', 0Dh, 0Ah, '$'
    MSG08      DB 'Ingrese el primer numero: ', 0Dh, 0Ah, '$'
    MSG09      DB 'Ingrese el segundo numero: ', 0Dh, 0Ah, '$'
    MSG10      DB '-> La suma es: ', 0Dh, 0Ah, '$'
    MSG11      DB '-> La resta es: ', 0Dh, 0Ah, '$'
    MSG12      DB '-> La multiplicacion es: ', 0Dh, 0Ah, '$'
    MSG13      DB 'Ingrese el dividendo: ', 0Dh, 0Ah, '$'
    MSG14      DB 'Ingrese el divisor (no use cero): ', 0Dh, 0Ah, '$'
    MSG15      DB '-> La division es: ', 0Dh, 0Ah, '$'
    MSG16      DB 'Saliendo de la calculadora. Adios!', 0Dh, 0Ah, '$'
    MSG17      DB '-> ERROR: Opcion no valida.', 0Dh, 0Ah, '$'
    MSG18      DB '', 0Dh, 0Ah, '$'
